...
/**
 * Make sure a path is absolute, and convert to absolute based on cwd if needed.
 * @param   {string} filepath absolute or relative filepath
 * @param   {string} baseDir  Directory the file is relative to (if it's a relative file)
...
function ensureAbsolute(filepath, baseDir) {
    ...
    throw new Error("Must provide a baseDir for relative file paths.");
}
