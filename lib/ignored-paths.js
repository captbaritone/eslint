...
function normalizeAndResolveFilepath(filepath, baseDir) {
    filepath = pathUtil.normalizeFilepath(filepath);
    return pathUtil.resolveFilepath(filepath, baseDir);
}
...
IgnoredPaths.prototype.contains = function(filepath, category) {
    ...
    var result = false;
    filepath = pathUtil.ensureAbsolute(filepath, this.options.cwd);
